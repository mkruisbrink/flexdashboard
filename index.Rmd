...
> Active, inactive and 'dead' projects as listed by Nomics.com. Projects are considered active if a certain trading treshold is reached.
...
> Proportion of active, inactive and dead projects for the main cryptocurrency platforms.
...
> Proportion of cryptocurrency platforms for all active, inactive and dead projects.
...
> Aggregated historical monthly market capitalization data on a logarithmic scale.
...
> Aggregated historical monthly market volume data on a logarithmic scale.
...
> Just a reminder for when you want to invest in traditional stocks. Cryptocurrency such as BTC and ETH have vastly outperformed the major corporations such as Apple (and even Tesla) over the past years. 
...
> Simple line chart of values for the Fear & Greed index as listed by alternative.me.
...
> Scatter plot with color highlighting the different phases of 'fear' or 'greed'. 
...
> Bar chart listing the cumulative time we have spent in different phases. You can clearly see there has been a lot more of 'extreme fear' than there has been 'extreme greed'.
...
> Pie chart listing the cumulative time we have spent in different phases. You can clearly see there has been a lot more of 'extreme fear' than there has been 'extreme greed'.
...
> Seasonally adjusted data on Dutch consumers' views and expectations regarding general economic developments and their own financial situation. The indicators can have a value from -100 (everyone answers negative) to +100 (everyone answers positive). With a value of 0, the proportion of pessimists equals the proportion of optimists.
...
> Consumer confidence is an indicator that provides information about consumers' confidence and perceptions regarding developments in the Dutch economy and their own financial situation.
